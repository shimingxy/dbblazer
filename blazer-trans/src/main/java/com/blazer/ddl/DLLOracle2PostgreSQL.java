 ...
 *
 */
public class DLLOracle2PostgreSQL  extends DLLOracle2Greenplum{
	private static final Logger _logger = LoggerFactory.getLogger(DLLOracle2PostgreSQL.class);
	
	/**
	 * 
	 */
	public DLLOracle2PostgreSQL() {

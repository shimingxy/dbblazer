 ...
 * 
 */
public class TransOracle2PostgreSQL extends TransBase {
	private static final Logger _logger = LoggerFactory.getLogger(TransOracle2PostgreSQL.class);
	
	public TransOracle2PostgreSQL(

 ...
 * 
 */
public class TransOracle2Oracle extends TransBase {
	private static final Logger _logger = LoggerFactory.getLogger(TransOracle2Oracle.class);
	
	
	public TransOracle2Oracle(

 ...
 * 
 */
public class TransGreenplum2Oracle extends TransBase {
	private static final Logger _logger = LoggerFactory.getLogger(TransGreenplum2Oracle.class);
	
	public TransGreenplum2Oracle(

 ...
 * 
 */
public class TransPostgreSQL2Oracle extends TransBase {
	private static final Logger _logger = LoggerFactory.getLogger(TransPostgreSQL2Oracle.class);
	
	public TransPostgreSQL2Oracle(

 ...
 * 
 */
public class TransDataExport2Sql extends BasicConfigure implements Runnable{
	private static final Logger _logger = LoggerFactory.getLogger(TransDataExport2Sql.class);
	...
	public TransDataExport2Sql(DataSource sourceDataSource,int commitNumber, int threadNumber,
